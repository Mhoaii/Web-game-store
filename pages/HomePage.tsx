...
const heroGame = games.find(g => g.id === 'cybernetic-horizon') || games[0];
                        ...
                        <main className="mt-8 flex flex-col gap-12 px-4 md:px-10 lg:px-20">
                            ...
                            <div className="@container">
                                <div className="@[480px]:p-0">
                                    <div className="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-xl items-start justify-end px-4 pb-10 @[480px]:px-10" data-alt={`Promotional image for the game ${heroGame.title}`} style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.6) 100%), url("${heroGame.imageUrl}")` }}>
