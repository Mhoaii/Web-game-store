        ...
        <div className="w-full max-w-md bg-white dark:bg-[#1e2532] rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              ...
              className="w-full py-3.5 rounded-lg bg-primary hover:bg-primary/90 text-white font-bold text-lg shadow-lg shadow-primary/25 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isSubmitting ? (
